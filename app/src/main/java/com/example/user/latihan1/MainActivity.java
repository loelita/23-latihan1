package com.example.user.latihan1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        public void onClick(View v) {
            ...
            String email = editEmail.getText().toString(); Intent i;

            i	= new Intent(MainActivity.this,MainActivity.class); Bundle b =new Bundle(); b.putString("parse_nama", nama); b.putInt("parse_tahun", tahun); b.putString("parse_alamat",alamat); b.putInt("parse_telepon", telepon); b.putString("parse_email", email);
